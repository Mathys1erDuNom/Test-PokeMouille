...
INPUT_FILE  = os.path.join(root_dir, "json", "actu","chateauenfoui","pokemon_chateauenfoui_normal.json")
OUTPUT_FILE = os.path.join(root_dir, "json", "actu","chateauenfoui","pokemon_chateauenfoui_shiny.json")
# ──────────────────────────────────────────────────────────────────────────────
